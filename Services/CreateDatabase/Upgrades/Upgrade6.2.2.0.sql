...
/* 
	Recreation of all PAF-ECF DB triggers as all "inserts" should also log the PK as done with the "updates"
*/
...
BEGIN
	...
	DECLARE @TAXLIMITMININS NUMERIC
	...
	DECLARE @TAXLIMITMINDEL NUMERIC
